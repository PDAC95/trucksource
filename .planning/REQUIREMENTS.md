...
- [x] **MSG-05**: After the contact form is submitted, a private in-site chat thread opens between buyer and seller
- [x] **MSG-06**: Buyer and seller can exchange messages in the in-site chat without exposing seller PII
- [x] **MSG-07**: User can report a listing, comment, or message for abuse
